...
class Interfaz:
    ...
    def ventana(self):
        ...
        mainwindow.title('Máquina de Turing')
        #mainwindow.resizable(0, 0)
        mainwindow.config(bg='#7FADA9')

        # Título
        titulo = Label(mainwindow, text='Máquina de Turing', font=('JetBrains Mono', 20), bg='#7FADA9').grid(row=0, column=0, columnspan=11, pady=10)

        # Entradas
        cinta1 = Label(mainwindow, text='Cinta 1:', font=('JetBrains Mono', 15), bg='#7FADA9').grid(row=1, column=0, columnspan=11, padx=10)

        self.cinta1 = StringVar()
        entrada_texto = Entry(mainwindow, font=('JetBrains Mono', 15), width=30, textvariable=self.cinta1).grid(row=2, column=0, padx=10, columnspan=11)

        cinta2 = Label(mainwindow, text='Cinta 2:', font=('JetBrains Mono', 15), bg='#7FADA9').grid(row=3, column=0, pady=10, padx=10, columnspan=11)

        self.cinta2 = StringVar()
        entrada_texto2 = Entry(mainwindow, font=('JetBrains Mono', 15), width=30, textvariable=self.cinta2).grid(row=4, column=0, pady=10, padx=10, columnspan=11)

        # Botones
        boton = Button(mainwindow, width=15, text='Evualuar', font=('JetBrains Mono', 15), bg='#22b814', fg='#ffffff',activebackground='#1a8a0f', activeforeground='#fff', relief='flat', borderwidth=0, command=self.envio).grid(row=5, column=0, pady=10, padx=10, columnspan=11)

        boton2 = Button(mainwindow, width=15, text='Limpiar', font=('JetBrains Mono', 15), bg='#ff0000', fg='#ffffff',activebackground='#990000', activeforeground='#fff', relief='flat', borderwidth=0, command=self.limpiar).grid(row=6, column=0, pady=10, padx=10, columnspan=11)

        #* Etiquetas de salida: Primera fila
        self.c1f1 = Label(mainwindow, text='0', font=('JetBrains Mono', 15), bg='#b6bfca')
        self.c1f1.grid(row=10, column=10, padx=10)

        self.c1f2 = Label(mainwindow, text='0', font=('JetBrains Mono', 15), bg='#b6bfca')
        self.c1f2.grid(row=11, column=10, padx=10)

        self.c1f3 = Label(mainwindow, text='0', font=('JetBrains Mono', 15), bg='#b6bfca')
        self.c1f3.grid(row=12, column=10, padx=10)

        self.c1f4 = Label(mainwindow, text='-', font=('JetBrains Mono', 15), bg='#b6bfca')
        self.c1f4.grid(row=13, column=10, padx=10)

        #* Segunda fila
        self.c2f1 = Label(mainwindow, text='0', font=('JetBrains Mono', 15), bg='#b6bfca')
        self.c2f1.grid(row=10, column=9, padx=10)

        self.c2f2 = Label(mainwindow, text='0', font=('JetBrains Mono', 15), bg='#b6bfca')
        self.c2f2.grid(row=11, column=9, padx=10)

        self.c2f3 = Label(mainwindow, text='0', font=('JetBrains Mono', 15), bg='#b6bfca')
        self.c2f3.grid(row=12, column=9, padx=10)

        self.c2f4 = Label(mainwindow, text='-', font=('JetBrains Mono', 15), bg='#b6bfca')
        self.c2f4.grid(row=13, column=9, padx=10)

        #* Tercera fila
        self.c3f1 = Label(mainwindow, text='0', font=('JetBrains Mono', 15), bg='#b6bfca')
        self.c3f1.grid(row=10, column=8, padx=10)

        self.c3f2 = Label(mainwindow, text='0', font=('JetBrains Mono', 15), bg='#b6bfca')
        self.c3f2.grid(row=11, column=8, padx=10)

        self.c3f3 = Label(mainwindow, text='0', font=('JetBrains Mono', 15), bg='#b6bfca')
        self.c3f3.grid(row=12, column=8, padx=10)

        self.c3f4 = Label(mainwindow, text='-', font=('JetBrains Mono', 15), bg='#b6bfca')
        self.c3f4.grid(row=13, column=8, padx=10)

        #* Cuarta fila
        self.c4f1 = Label(mainwindow, text='0', font=('JetBrains Mono', 15), bg='#b6bfca')
        self.c4f1.grid(row=10, column=7, padx=10)

        self.c4f2 = Label(mainwindow, text='0', font=('JetBrains Mono', 15), bg='#b6bfca')
        self.c4f2.grid(row=11, column=7, padx=10)

        self.c4f3 = Label(mainwindow, text='0', font=('JetBrains Mono', 15), bg='#b6bfca')
        self.c4f3.grid(row=12, column=7, padx=10)

        self.c4f4 = Label(mainwindow, text='-', font=('JetBrains Mono', 15), bg='#b6bfca')
        self.c4f4.grid(row=13, column=7, padx=10)

        #* Quinta fila
        self.c5f1 = Label(mainwindow, text='0', font=('JetBrains Mono', 15), bg='#b6bfca')
        self.c5f1.grid(row=10, column=6, padx=10)

        self.c5f2 = Label(mainwindow, text='0', font=('JetBrains Mono', 15), bg='#b6bfca')
        self.c5f2.grid(row=11, column=6, padx=10)

        self.c5f3 = Label(mainwindow, text='0', font=('JetBrains Mono', 15), bg='#b6bfca')
        self.c5f3.grid(row=12, column=6, padx=10)

        self.c5f4 = Label(mainwindow, text='-', font=('JetBrains Mono', 15), bg='#b6bfca')
        self.c5f4.grid(row=13, column=6, padx=10)

        #* Sexta fila
        self.c6f1 = Label(mainwindow, text='0', font=('JetBrains Mono', 15), bg='#b6bfca')
        self.c6f1.grid(row=10, column=5, padx=10)

        self.c6f2 = Label(mainwindow, text='0', font=('JetBrains Mono', 15), bg='#b6bfca')
        self.c6f2.grid(row=11, column=5, padx=10)

        self.c6f3 = Label(mainwindow, text='0', font=('JetBrains Mono', 15), bg='#b6bfca')
        self.c6f3.grid(row=12, column=5, padx=10)

        self.c6f4 = Label(mainwindow, text='-', font=('JetBrains Mono', 15), bg='#b6bfca')
        self.c6f4.grid(row=13, column=5, padx=10)

        #* Séptima fila
        self.c7f1 = Label(mainwindow, text='0', font=('JetBrains Mono', 15), bg='#b6bfca')
        self.c7f1.grid(row=10, column=4, padx=10)

        self.c7f2 = Label(mainwindow, text='0', font=('JetBrains Mono', 15), bg='#b6bfca')
        self.c7f2.grid(row=11, column=4, padx=10)

        self.c7f3 = Label(mainwindow, text='0', font=('JetBrains Mono', 15), bg='#b6bfca')
        self.c7f3.grid(row=12, column=4, padx=10)

        self.c7f4 = Label(mainwindow, text='-', font=('JetBrains Mono', 15), bg='#b6bfca')
        self.c7f4.grid(row=13, column=4, padx=10)

        #* Octava fila

        self.c8f1 = Label(mainwindow, text='0', font=('JetBrains Mono', 15), bg='#b6bfca')
        self.c8f1.grid(row=10, column=3, padx=10)

        self.c8f2 = Label(mainwindow, text='0', font=('JetBrains Mono', 15), bg='#b6bfca')
        self.c8f2.grid(row=11, column=3, padx=10)

        self.c8f3 = Label(mainwindow, text='0', font=('JetBrains Mono', 15), bg='#b6bfca')
        self.c8f3.grid(row=12, column=3, padx=10)

        self.c8f4 = Label(mainwindow, text='-', font=('JetBrains Mono', 15), bg='#b6bfca')
        self.c8f4.grid(row=13, column=3, padx=10)

        #* Novena fila
        self.c9f1 = Label(mainwindow, text='0', font=('JetBrains Mono', 15), bg='#b6bfca')
        self.c9f1.grid(row=10, column=2, padx=10)

        self.c9f2 = Label(mainwindow, text='0', font=('JetBrains Mono', 15), bg='#b6bfca')
        self.c9f2.grid(row=11, column=2, padx=10)

        self.c9f3 = Label(mainwindow, text='0', font=('JetBrains Mono', 15), bg='#b6bfca')
        self.c9f3.grid(row=12, column=2, padx=10)

        self.c9f4 = Label(mainwindow, text='-', font=('JetBrains Mono', 15), bg='#b6bfca')
        self.c9f4.grid(row=13, column=2, padx=10)

        #* Décima fila
        self.c10f1 = Label(mainwindow, text='0', font=('JetBrains Mono', 15), bg='#b6bfca')
        self.c10f1.grid(row=10, column=1, padx=10)

        self.c10f2 = Label(mainwindow, text='0', font=('JetBrains Mono', 15), bg='#b6bfca')
        self.c10f2.grid(row=11, column=1, padx=10)

        self.c10f3 = Label(mainwindow, text='0', font=('JetBrains Mono', 15), bg='#b6bfca')
        self.c10f3.grid(row=12, column=1, padx=10)

        self.c10f4 = Label(mainwindow, text='-', font=('JetBrains Mono', 15), bg='#b6bfca')
        self.c10f4.grid(row=13, column=1, padx=10)

        #* Undécima fila
        self.c11f1 = Label(mainwindow, text='0', font=('JetBrains Mono', 15), bg='#b6bfca')
        self.c11f1.grid(row=10, column=0, padx=10)

        self.c11f2 = Label(mainwindow, text='0', font=('JetBrains Mono', 15), bg='#b6bfca')
        self.c11f2.grid(row=11, column=0, padx=10)

        self.c11f3 = Label(mainwindow, text='0', font=('JetBrains Mono', 15), bg='#b6bfca')
        self.c11f3.grid(row=12, column=0, padx=10)

        self.c11f4 = Label(mainwindow, text='-', font=('JetBrains Mono', 15), bg='#b6bfca')
        ...
        if cinta1 != '' or cinta2 != '':
            ...
            if len_cinta1 <= 10 and len_cinta2 <= 10:
                ...
                if flag_cinta1 and flag_cinta2:
                    ...
                    listado, tape_1, tape_2 = maquina.create_tapes(cinta1, cinta2)
                    ...
                    maquina.procedure(tape_1, tape_2)
                else:
